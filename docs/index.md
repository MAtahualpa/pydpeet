...
- [Installation](installation.md) explains how to install PyDPEET from PyPI, starting from Python or Miniconda installation and ending with a working setup in editors such as VS Code.
